...
_ZLDSCREENNAME="signalysisinc"; //No I18N
_ZLDEMBEDNAME="signalysisinc";  //No I18N
_ZLDUTSSERVER="vts.zohopublic.com";  //No I18N
_LANG = "en";  //No I18N
var _CCODE= "US"; //No I18N
var isnewembed = false;//No I18N
...
_IS_FORCE_UTS_SECURE = false; //No I18N
    _COMMONSTATICURL = "https://static.zohocdn.com"; //No I18N
...
function ZloadFiles()
{
  ...
  ocss.rel ="stylesheet";
  ocss.href = "https://css.zohocdn.com/salesiq/styles/floatsupportbtn_be794b86e12de3509d17b4da5f462a94_.css";  
  ...
  try
  {
		...
		if(ie && document.compatMode!="CSS1Compat")
		{
				var ocss = document.createElement("link");
				ocss.rel ="stylesheet";
				ocss.href = "https://css.zohocdn.com/salesiq/styles/floatiebtnfix_b4db4efbd63ff92c71eba4829896b7ad_.css";  
				headArr[0].appendChild(ocss);
		}
  ...
  oscript.src="https://js.zohocdn.com/salesiq/js/track_c885585ec5f876139e2683e71d5f524c_.js";  //No I18N
  headArr[0].appendChild(oscript);//No I18N
}
...
function ZaddEvent()
{
  	...
  	var iframeurl = "https://salesiq.zohopublic.com/signalysisinc/drawchat.ls?";  	
    var _zldcpage = "https://www.signalysis.com/"; 
  ...
  _ZSIQ.initSIQAPI = _ZSIQ.initSIQAPI || function()   //No I18N
  {
    ...
    var floatcookie = readCookie('zld208405000000002043float');//No I18N
	...
	lsid:'208405000000002043' // NO I18N
	};
	try
	{
  ...
  _ZSIQ.initFloat = function()//No I18N
  {
	Float.newembed = false;//No I18N
		...
		Float.lsobject["screenname"]="signalysisinc" ;
		...
		Float.lsobject.currdomain = "signalysis.com";
		Float.lsobject["float_fkey"]="0_208405000000002043"; 
